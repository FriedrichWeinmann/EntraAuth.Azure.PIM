...
Remove-Module EntraAuth.Azure.PIM -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\EntraAuth.Azure.PIM\EntraAuth.Azure.PIM.psd1"
Import-Module "$PSScriptRoot\..\EntraAuth.Azure.PIM\EntraAuth.Azure.PIM.psm1" -Force
