...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\EntraAuth.Azure.PIM\functions", "$global:testroot\..\EntraAuth.Azure.PIM\internal\functions"),
	
	[string]
	$ModuleName = "EntraAuth.Azure.PIM",
...
$CommandPath = @(
    "$global:testroot\..\EntraAuth.Azure.PIM\functions"
    "$global:testroot\..\EntraAuth.Azure.PIM\internal\functions"
)
